  ...
  useEffect(() => {
    const fetchHome = async () => {
      try {
        ...
        // Try with Beauty category (simple name)
        const categoryRes = await API.get("/products?category=Beauty&limit=10");
        console.log('Beauty category response:', categoryRes.data);
